...
class TrucksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create truck" do
    assert_difference("Truck.count") do
      post trucks_url, params: { truck: { description: @truck.description, model: @truck.model, name: @truck.name, plate: @truck.plate } }
    end
  ...
  test "should update truck" do
    patch truck_url(@truck), params: { truck: { description: @truck.description, model: @truck.model, name: @truck.name, plate: @truck.plate } }
