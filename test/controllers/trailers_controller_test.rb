...
class TrailersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trailer" do
    assert_difference("Trailer.count") do
      post trailers_url, params: { trailer: { description: @trailer.description, model: @trailer.model, name: @trailer.name, plate: @trailer.plate } }
    end
  ...
  test "should update trailer" do
    patch trailer_url(@trailer), params: { trailer: { description: @trailer.description, model: @trailer.model, name: @trailer.name, plate: @trailer.plate } }
